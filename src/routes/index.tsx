...
export const router = createBrowserRouter([
  { element: <LandingLayout />, children: [{ path: '/', element: <LandingPage /> }] },
  { element: <AuthLayout />, children: [{ path: '/auth/login', element: <LoginPage /> }, { path: '/auth/register', element: <RegisterPage /> }] },
  { element: <RequireAuth role="parent"><DashboardLayout /></RequireAuth>, children: parentRoutes },
  { element: <RequireAuth role="student"><DashboardLayout /></RequireAuth>, children: studentRoutes },
])

export const routes = {
  landing: '/', login: '/auth/login', register: '/auth/register', parent: '/parent', child: '/child', weeklyLearning: '/weekly-learning', assignments: '/assignments', reports: '/reports', settings: '/settings', ai: '/ai', student: '/student', studentLearning: '/student/learning', studentAssignments: '/student/assignments', studentProgress: '/student/progress', studentAi: '/student/ai', studentProfile: '/student/profile',
} as const
